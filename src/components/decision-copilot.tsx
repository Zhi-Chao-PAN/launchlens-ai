      ...
      <div className="grid gap-5 p-5 xl:grid-cols-[280px_1fr]">
        <div>
          ...
          <button
            ...
            className="mt-4 flex h-11 w-full items-center justify-center gap-2 rounded-md bg-[#17201d] px-4 text-sm font-semibold text-white transition hover:bg-[#24312d] disabled:cursor-not-allowed disabled:opacity-50"
          >
            {isGenerating ? (
