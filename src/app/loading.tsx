    ...
    <main className="min-h-screen bg-[#f6f8f4]">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3 border-b border-[#d8ded4] pb-5">
          <div className="h-11 w-11 animate-pulse rounded-lg bg-[#e5e9e1]" />
          <div className="flex-1 space-y-2">
            <div className="h-3 w-24 animate-pulse rounded bg-[#e5e9e1]" />
            <div className="h-6 w-48 animate-pulse rounded bg-[#e5e9e1]" />
          </div>
        </div>
