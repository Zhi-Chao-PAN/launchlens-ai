...
const STORAGE_KEY = "launchlens.locale";
...
function detectInitialLocale(): Locale {
  ...
  // Auto-detect Chinese from the browser language; everything else stays
  // English (the default and the original language of the app).
...
export function LocaleProvider({ children }: { children: ReactNode }) {
  ...
  // Detect once on mount to avoid SSR/CSR hydration mismatch: the server
  // always renders the default locale, and the client refines from
  // localStorage / navigator after hydration.
  useEffect(() => {
