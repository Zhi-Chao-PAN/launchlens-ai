...
- Analysis Companion: an optional reader-assistance layer that explains metrics and workspace sections through deterministic product guidance. V1 should avoid extra AI calls and should never alter workspace data.
...
Analysis Companion should be opt-in. When disabled, the workspace should behave like a normal product surface. When enabled, hover/focus interactions may update the companion panel, but they must not block editing, exporting, validation, or decision workflows.
